...
const areasOfInterest = ["Consulting","Training and Certification","Java Application Servers","Redhat Enterprise Linux","Developer Productivity Tools","Middleware Solutions","Platform Management","O~ Portals ~O","JBoss"];
